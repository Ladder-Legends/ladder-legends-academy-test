  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at top left, rgba(239, 68, 68, 0.03) 0%, transparent 50%),
            radial-gradient(circle at top right, rgba(249, 115, 22, 0.03) 0%, transparent 50%),
            radial-gradient(circle at bottom left, rgba(249, 115, 22, 0.02) 0%, transparent 50%),
            radial-gradient(circle at bottom right, rgba(239, 68, 68, 0.02) 0%, transparent 50%)
          `
        }}
      />
