            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline">{fingerprint.tactical.moveouts?.length || 0}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm">Harass</span>
                  <Badge variant="outline">{fingerprint.tactical.harass?.length || 0}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm">Engagements</span>
                  <Badge variant="outline">{fingerprint.tactical.engagements?.length || 0}</Badge>
                </div>
              </CardContent>
            </Card>
          )}
